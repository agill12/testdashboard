import csv
with open('data/newatlantic.csv','r') as fin,open('data/newatlantictest2.csv','w') as fout,open('data/storms.csv','r') as fin2:
    ...
    all_winds=[]
    truths=[]
    #for row_number,row in enumerate(hurricanes):
    for row in storms:
        row.append('CAT4')
        row.append('L')
